...
class AgencyLicenses extends Component {
  ...
  render() {
    return (
      <div className={style.component}>
        <Header title="Agency Licenses" />
        <p>Please identify your licenses</p>
...
AgencyLicenses.propTypes = {
  router: PropTypes.object.isRequired,
  validate: PropTypes.func,
  next: PropTypes.string.isRequired,
};

AgencyLicenses.defaultProps = {
  validate: () => '',
};
